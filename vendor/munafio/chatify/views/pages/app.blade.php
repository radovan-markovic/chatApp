        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="fas fa-users"></span> People</a>
            </div>
        </div>
        {{-- tabs and lists --}}
        <div class="m-body">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url('http://localhost:8000/storage/users-avatar/avatar.png');">
                    </div>
